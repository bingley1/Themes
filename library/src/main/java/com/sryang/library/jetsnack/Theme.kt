...
fun JetsnackTheme(
    ...
    MaterialTheme(
        colorScheme = debugColors(darkTheme, colors),
...
fun debugColors(
    darkTheme: Boolean,
    debugColor: JetsnackColors,
) = lightColorScheme(
    primary = debugColor.brand,
    secondary = debugColor.brandSecondary,
    background = debugColor.uiBackground,
    surface = debugColor.uiBorder,
    error = debugColor.error,
    onPrimary = debugColor.iconPrimary,
    onSecondary = debugColor.iconSecondary,
    onBackground = debugColor.iconInteractive,
    onSurface = debugColor.iconInteractiveInactive,
    onError = debugColor.textLink,
)
